...
public class BaseRestAdminResource<T extends BaseEntity> {
    private Logger logger = LoggerFactory.getLogger(BaseRestAdminResource.class);
    ...
    public BaseRestAdminResource() {
        setParameterisedBusinessClass();
        om.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
    }

    public BaseRestAdminResource(IService service) {
        this();
